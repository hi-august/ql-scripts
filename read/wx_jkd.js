...
async function qxread() {
    return new Promise((resolve) => {
        ...
        let nm = {
            ...
            body: `jsondata={  "appid" : "xzwl",  "read_weal" : 0,  "paytype" : 1,  "securitykey" : "",  "channel" : "iOS",  "psign" : "${
                qxhd.psign
            }",  "appversioncode" : "565",  "time" : "1630332532",  "apptoken" : "${
                qxhd.apptoken
            }",  "appversion" : "5.6.5",  "openid" : "${
                qxhd.openid
            }",  "os" : "iOS",  "artid" : 812907${Math.round(
                Math.random() * 9
            )}${s},  "accountType" : "0",  "readmodel" : "1"}`,
...
async function qlread() {
    return new Promise((resolve) => {
        ...
        let nm = {
            url: `https://www.xiaodouzhuan.cn/jkd/account/readAccount.action`,
            body: `jsondata={  "appid" : "xzwl",  "read_weal" : 0,  "paytype" : 1,  "securitykey" : "",  "channel" : "iOS",  "psign" : "92dea068b6c271161be05ed358b59932",  "appversioncode" : "565",  "time" : "1630332532",  "apptoken" : "xzwltoken070704",  "appversion" : "5.6.5",  "openid" : "${
                qlhd.openid
            }",  "os" : "iOS",  "artid" : 812907${Math.round(
                Math.random() * 9
            )}${s},  "accountType" : "0",  "readmodel" : "1"}`,
